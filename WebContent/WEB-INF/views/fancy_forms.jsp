...
<body>
	...
	<form method="post" action="AddFlightTicketToPassenger">
		...
		<input name="fid1" type="text"></input>

		to a passenger with an id of

		<input name="pid1" type="text"></input>	
	...
	<form action="AddDepartement" method="post">
		...
		Department Name : <input name="dep_name" type="text" /><br><br>
	...
	<form action="AddEmployee" method="post">
		<h1>Add Employee</h1>
		First Name : <input name="emp_fName"/><br><br>
		Last Name : <input name="emp_lName"/><br><br>
		Gender :
		 <select name="emp_gender">
				<option value="Male">Male</option>
	 			<option value="Female">Female</option>
		</select><br><br>
		Date of birth : <input name="emp_dob" type="text"/><br><br>
		Phone: <input name="emp_phone"/><br><br>
		Email : <input name="emp_email" /><br><br>
		Department : <input name="emp_dep"/><br><br>
